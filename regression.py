...
if __name__ == '__main__':
   ...
   '''
    ...
    '''
    Print the weights inferred by the regression, please uncomment it to see the estimated weights
    print("estimated weights", model.weight.data)
    print("real weights", w_star)
    '''

    '''
    Plot the polynomial defined by w_star and the polynomial defined by the model.weights considering 100 points
